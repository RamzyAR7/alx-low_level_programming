...
/**
 * f4 - Find the biggest ASCII value from the username.
 * @usrn: Username
 * @len: Length of username
 *
 * Return: Biggest ASCII value.
 */
...
/**
 * f5 - Calculate a random character based on the username.
 * @usrn: Username
 * @len: Length of username
 *
...
int f5(char *usrn, int len)
{
	...
	ch = vch = 0;
	/* Calculate a random character based on the username*/
	while (vch < len)
	{
...
/**
 * f6 - Calculate a random character based on the username.
 * @usrn: Username
 *
 * Return: Random character
 *
